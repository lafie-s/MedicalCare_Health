...
创建日期：2026-09-07。状态：初始计划，尚未进入功能开发。
...
| M0 调研 | 3 | MedicalCareWeb 资料 | 指标范围、栈、身份协议、数据源、维护接口及容量目标明确 | 待开始 |
| F01 基础与权限 | 4 | M0 | 可启动工程、登录与环境权限验证通过 | 待开始 |
...
| 风险 | 影响 | 应对 |
| --- | --- | --- |
| 健康指标实际包含患者数据 | 范围和数据设计变化 | M0 明确定义并重排，不直接套用系统监控模型 |
