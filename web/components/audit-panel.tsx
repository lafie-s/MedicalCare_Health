...
const categories = { all: "全部操作", service: "服务配置", probe: "HTTP 探测", alert: "告警处理", maintenance: "维护操作", release: "网站版本" };
const operations: Record<string, string> = { "release.started": "开始版本变更", "release.succeeded": "版本变更成功", "release.failed": "版本变更未生效", "release.unknown": "版本结果待核对", "service.created": "登记服务", "service.updated": "更新服务", "probe.started": "开始探测", "probe.finished": "完成探测", "alert.rule_saved": "保存告警规则", "alert.fired": "触发告警", "alert.recovered": "告警恢复", "alert.terminated": "终止告警", "alert.acknowledge": "确认告警", "alert.close": "关闭告警", "maintenance.access_saved": "修改维护访问控制", "maintenance.created": "登记维护窗口", "maintenance.canceled": "取消维护窗口" };
