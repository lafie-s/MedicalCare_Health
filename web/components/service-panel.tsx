...
export function ServicePanel({ environmentId, role, launcher, onCloseLauncher, onUnauthorized }: { environmentId: string; role: string; launcher: "release" | "access" | null; onCloseLauncher: () => void; onUnauthorized: () => void }) {
